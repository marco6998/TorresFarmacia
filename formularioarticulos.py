...
class FormularioArticulos:
    ...
    def carga_articulos(self):
        ...
        self.ubiacion_idcarga=tk.StringVar()
        self.entryubiacion_id=ttk.Entry(self.labelframe1, textvariable=self.ubiacion_idcarga)
        self.entryubiacion_id.grid(column=1, row=8, padx=4, pady=4)
